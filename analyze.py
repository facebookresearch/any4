...
if __name__ == '__main__':
    ...
    parser.add_argument("--layer", type=int, default=0, help="Transformer layer to analyze")
    ...
    # Run Evaluation
    main(model_name=args.model_name, layer=args.layer, sub_layer=args.sub_layer, row=args.row, model_args=model_args, quant_method=quant_method, quant_args=quant_args, device=args.device, log_dir=args.log_dir, bnb_args=bnb_args)
